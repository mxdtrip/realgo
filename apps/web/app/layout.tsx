        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=111710140', 'ym');

              ym(111710140, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
            `,
          }}
        />
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-W6QGPJHT');
            `,
          }}
        />
      </head>
