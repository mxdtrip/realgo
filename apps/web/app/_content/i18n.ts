    ...
    pages: {
      ...
      reviews: {
        ...
        queue: {
          ...
          rateError: "Не удалось сохранить оценку.",
          dueNow: "срок подошёл",
      ...
      roadmap: {
        ...
        paceAhead: "идёшь с опережением",
        paceOnTrack: "идёшь по плану",
        paceBehind: "нужно наверстать",
        weekPlanAction: "Открыть план недели",
        ...
        personalizedPanelTitle: "Персональный маршрут подготовки",
