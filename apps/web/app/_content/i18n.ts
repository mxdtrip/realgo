...
const ru = {
  ...
  marketing: {
    hero: {
      ...
      lead:
        "ReAlgo сохраняет решённые задачи, помогает увидеть пробелы и возвращает нужные темы на повторение — чтобы на интервью не приходилось начинать с нуля.",
    ...
    proof: [
      ...
      { value: "FSRS", label: "расписание повторений" },
    ],
  ...
  cabinet: {
    ...
    shell: {
      ...
      report: {
        ...
        privacyNote:
          "Диагностика удаляется через 90 дней и не собирает значения форм, токены или хранилище. Скриншот удаляется через 30 дней.",
        ...
        screenshotAdd: "добавить скриншот",
        screenshotCapturing: "выбери вкладку…",
        screenshotRemove: "удалить скриншот",
        screenshotAlt: "Предпросмотр прикладываемого скриншота",
        screenshotHint: "Выбери вкладку или окно и проверь предпросмотр: снимок может содержать видимые данные.",
        screenshotFailed: "Скриншот не добавлен. Попробуй снова или отправь отчёт без него.",
