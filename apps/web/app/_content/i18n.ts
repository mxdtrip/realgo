  ...
  marketing: {
    hero: {
      ...
      auth: {
        ...
        checkEmailBefore: "Мы отправили письмо на",
        checkEmailAfter: "Перейдите по ссылке в нём, чтобы подтвердить почту — ссылка действует час.",
        checkEmailHint: "Не пришло письмо? Проверьте папку «Спам» или отправьте ссылку ещё раз.",
        resend: "Отправить письмо ещё раз",
        resendSending: "Отправляем…",
        resendSent: "Письмо отправлено ещё раз",
        resendError: "Не удалось отправить письмо. Попробуйте ещё раз.",
        forgotPassword: "Забыли свой пароль?",
        forgotPasswordAria: "Восстановление пароля",
        resetPasswordPrompt:
          "Введите почту, указанную при регистрации — пришлём ссылку для восстановления пароля.",
        resetPasswordSubmit: "Отправить ссылку",
        resetPasswordSending: "Отправляем…",
        resetSentBefore: "Если",
        resetSentAfter:
          "зарегистрирован у нас, мы отправили на него письмо со ссылкой для восстановления пароля — она действует час.",
