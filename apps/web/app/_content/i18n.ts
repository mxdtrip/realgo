    ...
    pages: {
      dashboard: {
        ...
        launcher: {
          ...
          emptyTitle: "Собери roadmap для практики",
          emptyMeta: "Выбери цель и дату собеседования — ReAlgo составит план и добавит задачи в практику.",
          buildRoadmap: "собрать roadmap",
