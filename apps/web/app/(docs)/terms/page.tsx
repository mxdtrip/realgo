        ...
        <section className="pattern-profile__section" id="plans">
          ...
          <div className="pattern-profile__body">
            <p>
              ...
              ограниченная функциональность) либо Pro (расширенная
              функциональность, разовая бессрочная лицензия за 699 ₽ — без
              подписки и периодических списаний). Состав тарифов приведён на
              странице <a href="/#pricing">realgo.dev/#pricing</a>. Порядок
              оплаты платного тарифа регулируется{" "}
